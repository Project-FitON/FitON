...
class SignUpPage extends StatelessWidget {
  ...
  child: Text(
    ...
    style: TextStyle(color: Colors.white), // Set text color to white
              ...
              OutlinedButton.icon(
  onPressed: () {},
  icon: Icon(Icons.login, color: Colors.red), // Icon color red
  label: Text(
    "Login with Google",
    style: TextStyle(color: Colors.red), // Set text color to red
              ...
              Spacer(),
              GestureDetector(onTap: () {Navigator.pop(context);}, child: Text("Already have an account? Login", style: TextStyle(color: Colors.red, fontWeight: FontWeight.bold))),
              SizedBox(height: 20),
            ],
          ),
        ),
